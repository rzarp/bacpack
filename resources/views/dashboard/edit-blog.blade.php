...
@section('content')
    ...
    <form action="{{ route('blog.update',['id' => $blog->id]) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
        @method('PUT')
        @csrf                                
    <div class="row">
                   ...
                   <div class="form-group">
                        <form>
                          <div class="form-group">
                            ...
                            <input type="file" name="gambar" class="form-control-file" id="exampleFormControlFile1"  value="{{ $blog->gambar }}" required>
                          </div>
                        </form>
