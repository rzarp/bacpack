...
<p class="section-lead">
    ...
    <a href="{{route('galeri.input')}}" class="btn btn-primary">Tambah Thread</a>
</p>
@else
...
<div class="card">
    <div class="card-header">
    <h4><a href="{{ url('galeri/' . $g->slug) }}">{{$g->title}}</a></h4>
    ...
    <div class="chocolat-parent">
        <a href="{{ asset($g->gambar) }}" class="chocolat-image" title="Just an example">
        <div data-crop-image="285" style="overflow: hidden; position: relative; height: 285px;">
            <img alt="image" src="{{ asset($g->gambar) }}" class="img-fluid">
        </div>
        </a>
    </div>
    <hr>
    
    <a href="{{ url('galeri/' . $g->slug) }}" class="btn btn-icon icon-left"><i class="fa fa-eye"></i> Lihat</a>
    <a href="{{ url('galeri/' . $g->slug) }}" class="btn btn-icon icon-left"><i class="fa fa-comment"></i >Komen</a>
